    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @endif
                <form action="/manajemen_setup/sekretariat/setup_sekretariat/{{ $sekretariat->id }}" method="POST"
                    ...
                    <div class="mb-5">
                        ...
                        <select name="kabupaten_kota" id="kabupaten_kota">
                            <option value="Kabupaten"
                                {{ old('kabupaten_kota', $sekretariat->kabupaten_kota) == 'Kabupaten' ? 'selected' : '' }}>
                                Kabupaten
                            </option>
                            <option value="Kota"
                                {{ old('kabupaten_kota', $sekretariat->kabupaten_kota) == 'Kota' ? 'selected' : '' }}>
                                Kota
                            </option>
                        </select>
                    </div>
                    <div class="mb-5">
                        ...
                        <textarea id="alamat" name="alamat" rows="4" cols="50">{{ old('alamat', $sekretariat->alamat) }}</textarea>
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" id="no_telp" name="no_telp"
                            ...
                            value="{{ old('no_telp', $sekretariat->no_telp) }}" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" id="email" name="email"
                            ...
                            value="{{ old('email', $sekretariat->email) }}" />
                    </div>
                    <div class="mb-5">
                        <label for="sekretaris"
                            class="block mb-2.5 text-sm font-medium text-heading">Sekretariat</label>
                        <input type="text" id="sekretaris" name="sekretaris"
                            class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                            placeholder="Masukan kepala dinas" required
                            value="{{ old('sekretaris', $sekretariat->sekretaris) }}" />
                    </div>
                    <div class="mb-5">
