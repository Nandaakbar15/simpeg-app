<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div class="mb-6">
                <a href="/riwayat_pendidikan/pendidikan_bahasa/view_form_tambah_pendidikan_bahasa"
                    class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="hidden xs:block ml-2">Tambah Riwayat Pendidikan Bahasa</span>
                </a>
            </div>

            <form action="/riwayat_pendidikan/pendidikan_bahasa/cariPendidikanBahasa" method="POST"
                enctype="multipart/form-data">
                @csrf
                <input type="text" name="cariPendidikanBahasa" id="cariPendidikanBahasa"
                    value="{{ request('cariPendidikanBahasa') }}" aria-label="Cari Riwayat Pendidikan Bahasa"
                    placeholder="Cari Riwayat Pendidikan Bahasa..." class="rounded-lg">
                <button type="submit"
                    class="inline-block rounded-lg shadow-lg text-white px-3 py-2 bg-blue-500 hover:bg-blue-700">Cari</button>
            </form>
        </div>
                ...
                <table class="w-full text-sm text-left rtl:text-right text-body">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Jenis Bahasa</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Bahasa</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Kemampuan Bicara</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <tbody>
                        @foreach ($riwayatPendidikanBahasa as $data)
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left">{{ $data->jenis_bahasa }}</div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left">
                                        {{ $data->bahasa }}
