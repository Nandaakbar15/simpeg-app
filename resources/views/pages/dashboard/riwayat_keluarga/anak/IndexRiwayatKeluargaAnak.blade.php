    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Data Riwayat Anak</h1>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div class="mb-6">
                <a href="/riwayat_keluarga/anak/view_tambah_data_anak"
                    class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="hidden xs:block ml-2">Tambah Anak</span>
                </a>
            </div>

            <form action="/riwayat_keluarga/anak/cariPegawaiAnak" enctype="multipart/form-data" method="POST">
                @csrf
                <input type="text" name="cariPegawaiAnak" value="{{ request('cariPegawaiAnak') }}"
                    placeholder="Cari Pegawai Anak..." aria-label="Cari Pegawai Anak" class="rounded-lg">
                <button type="submit"
                ...
                <table class="w-full text-sm text-left rtl:text-right text-body">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Nama Anak</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <tbody>
                        @foreach ($riwayatKeluargaAnak as $data)
                            <tr>
