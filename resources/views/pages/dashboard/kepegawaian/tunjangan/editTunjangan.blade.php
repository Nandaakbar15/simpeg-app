    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Form edit tunjangan</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @endif
                <form action="/kepegawaian/tunjangan/edit_tunjangan/{{ $tunjangan->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-5">
                        ...
                        <select name="pegawai_id" id="pegawai_id" class="rounded-lg">
                            ...
                            @foreach ($pegawai as $item)
                                <option value="{{ $item->id }}"
                                    {{ old('pegawai_id', $tunjangan->pegawai_id) == $item->id ? 'selected' : '' }}>
                                    {{ $item->nama }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div class="flex w-3/4 gap-4">
                            <input type="text" id="no_tunjangan" name="no_tunjangan"
                                ...
                                value="{{ old('no_tunjangan', $tunjangan->no_tunjangan) }}" />
                            ...
                            <input type="date" id="tgl_tunjangan" name="tgl_tunjangan"
                                ...
                                required value="{{ old('tgl_tunjangan', $tunjangan->tgl_tunjangan) }}"
                                placeholder="Masukan tanggal tunjangan" />
                        </div>
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="text" id="jenis_tunjangan_anak" name="jenis_tunjangan_anak"
                            ...
                            value="{{ old('jenis_tunjangan_anak', $tunjangan->jenis_tunjangan_anak) }}" />
                    </div>
                    <div class="mb-5">
                        ...
                        <input type="date" id="terhitung_mulai" name="terhitung_mulai"
                            ...
                            value="{{ old('terhitung_mulai', $tunjangan->terhitung_mulai) }}" />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div class="flex w-3/4 gap-4">
                            <input type="text" id="no_akta_perkawinan" name="no_akta_perkawinan"
                                ...
                                value="{{ old('no_akta_perkawinan', $tunjangan->no_akta_perkawinan) }}" />

                            <input type="date" id="tgl_akta_perkawinan" name="tgl_akta_perkawinan"
                                class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-lg focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs"
                                required value="{{ old('tgl_akta_perkawinan', $tunjangan->tgl_akta_perkawinan) }}"
                                placeholder="Masukan tanggal akta perkawinan" />
                        </div>
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div class="flex w-3/4 gap-4">
                            <input type="text" id="no_akta_kelahiran" name="no_akta_kelahiran"
                                ...
                                value="{{ old('no_akta_kelahiran', $tunjangan->no_akta_kelahiran) }}" />

                            <input type="date" id="tgl_akta_kelahiran" name="tgl_akta_kelahiran"
                                class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-lg focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs"
                                required value="{{ old('tgl_akta_kelahiran', $tunjangan->tgl_akta_kelahiran) }}"
                                placeholder="Masukan tanggal akta kelahiran" />
                        </div>
                    </div>
                    <div class="mb-5">
