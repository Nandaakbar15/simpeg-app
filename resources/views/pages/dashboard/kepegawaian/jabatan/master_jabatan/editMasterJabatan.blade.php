    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @endif
                <form action="/kepegawaian/master_jabatan/update_master_jabatan/{{ $masterJabatan->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-5">
                        <label for="nama_jabatan" class="block mb-2.5 text-sm font-medium text-heading">Nama Jabatan</label>
                        <input type="text" name="nama_jabatan" id="nama_jabatan" 
                            value="{{ old('nama_jabatan', $masterJabatan->nama_jabatan) }}"
