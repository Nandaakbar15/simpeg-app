<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div class="mb-6">
                <a href="/kepegawaian/jabatan/view_tambah_jabatan"
            ...
            <form action="/kepegawaian/jabatan/cariJabatan" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" name="cariJabatan" id="cariJabatan" value="{{ request('cariJabatan') }}"
                    aria-label="Cari Jabatan" placeholder="Cari Jabatan...">
