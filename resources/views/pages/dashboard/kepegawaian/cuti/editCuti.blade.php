    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Form edit riwayat cuti</h1>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @endif
                <form action="/kepegawaian/cuti/edit_riwayat_cuti/{{ $cuti->id }}" method="POST"
                    ...
                    <div class="mb-5">
                        ...
                        <select name="jenis_cuti" id="jenis_cuti" class="rounded-lg">
                            ...
                            <option value="Menikah" {{ $cuti->jenis_cuti == 'Menikah' ? 'selected' : '' }}>Menikah
                            </option>
                            <option value="Bersalin" {{ $cuti->jenis_cuti == 'Bersalin' ? 'selected' : '' }}>Bersalin
                            </option>
                            <option value="Meninggalkan Pekerjaan"
                                {{ $cuti->jenis_cuti == 'Meninggalkan Pekerjaan' ? 'selected' : '' }}>Meninggalkan
                                Pekerjaan</option>
                            <option value="Karena Alasan Penting"
                                {{ $cuti->jenis_cuti == 'Karena Alasan Penting' ? 'selected' : '' }}>Karena Alasan
                                Penting</option>
                            <option value="Diluar Tanggungan Negara"
                                {{ $cuti->jenis_cuti == 'Diluar Tanggungan Negara' ? 'selected' : '' }}>Diluar
                    ...
                    <button type="button"
                        ...
                        data-message="Apakah Anda yakin ingin menyimpan perubahan data cuti ini?">Save</button>
                </form>
            </div>
