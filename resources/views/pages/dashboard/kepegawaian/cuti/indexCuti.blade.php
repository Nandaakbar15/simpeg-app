<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="mb-6">
            <a href="/kepegawaian/cuti/view_form_tambah_cuti" class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                            ...
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="font-medium text-gray-800 dark:text-gray-100">
                                        <a href="/kepegawaian/cuti/download_surat_cuti/{{ $data->id }}"
                                           target="_blank"
                                           title="Download / Cetak Surat Cuti"
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center justify-center space-x-2">
                                        ...
                                        <form action="/kepegawaian/cuti/delete_cuti/{{ $data->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
