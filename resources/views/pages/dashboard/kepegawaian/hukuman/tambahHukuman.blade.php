                ...
                <form action="/kepegawaian/hukuman/tambah_data_hukuman" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <select name="jenis_hukuman" id="jenis_hukuman">
                            ...
                            <option value="Tunda Kenaikan Pangkat"></option>
                    ...
                    <div class="mb-5">
                        <label for="pejabat_pengesahan_hukuman"
                            class="block mb-2.5 text-sm font-medium text-heading">Pejabat Pengesahan Hukuman</label>
                        <input type="text" id="pejabat_pengesahan_hukuman" name="pejabat_pengesahan_hukuman"
                            class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs placeholder:text-body"
                            placeholder="Masukan isi teguran" required />
                    </div>
                    ...
                    <div class="flex items-center mb-5">
                        ...
                        <div class="flex w-3/4 gap-4">
                            ...
                            <input type="date" id="tmt_hukuman_selesai" name="tmt_hukuman_selesai"
                                class="bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 shadow-xs"
