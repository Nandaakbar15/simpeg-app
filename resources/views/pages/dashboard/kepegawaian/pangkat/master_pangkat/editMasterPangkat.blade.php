    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-5">
            <div class="grid gap-6 mb-6 md:grid-cols-2">
                ...
                @endif
                <form action="/kepegawaian/master_pangkat/edit_master_pangkat/{{ $masterPangkat->id }}" method="POST">
                    @csrf
                    @method('PUT')
                    
                    <div class="mb-5">
                        <label for="nama_pangkat" class="block mb-2.5 text-sm font-medium text-heading">Nama Pangkat</label>
                        <input type="text" name="nama_pangkat" id="nama_pangkat" 
                            value="{{ old('nama_pangkat', $masterPangkat->nama_pangkat) }}"
                    ...
                    <button type="button" class="text-white bg-blue-500 hover:bg-blue-700 rounded-lg text-sm px-4 py-2 confirm-save"
                        ...
                        data-message="Apakah Anda yakin ingin menyimpan perubahan master pangkat ini?">
                        Save Changes
                    </button>
                </form>
            </div>
