    ...
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-8">
            ...
            <div class="mb-4 sm:mb-0">
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">Data Mutasi</h1>
            </div>
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6 gap-4">
            <div class="mb-6">
                <a href="/kepegawaian/mutasi/view_form_tambah_mutasi"
                    class="btn bg-indigo-500 hover:bg-indigo-600 text-white">
                    <svg class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path
                            d="M15 7H9V1c0-.6-.4-1-1-1S7 .4 7 1v6H1c-.6 0-1 .4-1 1s.4 1 1 1h6v6c0 .6.4 1 1 1s1-.4 1-1V9h6c.6 0 1-.4 1-1s-.4-1-1-1z" />
                    </svg>
                    <span class="hidden xs:block ml-2">Tambah Mutasi</span>
                </a>
            </div>

            <form action="/kepegawaian/mutasi/cariMutasi" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="text" name="cariMutasi" id="cariMutasi" aria-label="Cari Mutasi"
                    placeholder="Cari Mutasi..." value="{{ request('cariMutasi') }}" class="rounded-lg">
                <button type="submit"
                ...
                <table class="w-full text-sm text-left rtl:text-right text-body">
                    <thead
                        ...
                        <tr>
                            ...
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="font-semibold text-left">Instansi Tujuan</div>
                            </th>
                            <th class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <tbody>
                        @foreach ($mutasi as $data)
                            <tr>
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left">{{ $data->jenis_mutasi }}</div>
                                </td>
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                    <div class="text-left">
                                        {{ $data->tgl_sk_mutasi }}
                                ...
                                <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap w-px">
                                    <div class="flex items-center justify-center space-x-2">
                                        <a href="/kepegawaian/mutasi/view_form_edit_mutasi/{{ $data->id }}"
                                            ...
                                            data-message="Apakah Anda yakin ingin mengedit data mutasi ini?">
                                            Edit
                                        </a>
                                        <form action="/kepegawaian/mutasi/delete_mutasi/{{ $data->id }}"
                                            method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                                ...
                                                data-message="Apakah Anda yakin ingin menghapus data mutasi ini? Data yang dihapus tidak dapat dikembalikan.">
                                                Delete
                                            </button>
                                        </form>
                                    </div>
