<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-6">
            <div class="mb-4 sm:mb-0">
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                    Report <span class="text-base font-normal text-gray-500 dark:text-gray-400">Bezetting</span>
                </h1>
            </div>
            @if ($selectedUnitKerja && $pegawaiList->isNotEmpty())
                <a href="{{ route('report.bezetting.print', ['unit_kerja_id' => $selectedUnitKerja->id]) }}"
                    target="_blank"
        ...
        <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-5 mb-6">
            <form method="GET" action="{{ url('/report/bezetting') }}"
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="text-center mb-5">
                    <p class="font-bold text-gray-800 dark:text-gray-100 uppercase tracking-wide text-sm">
                        DAFTAR BEZETTING PNS
                    </p>
                    <p class="text-xs text-gray-600 dark:text-gray-400 mt-1 uppercase">
                        PADA {{ strtoupper($selectedUnitKerja->nama_unit) }}
                        @if ($instansi)
                    ...
                    <table class="w-full text-xs border-collapse border border-gray-300 dark:border-gray-600">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center w-8">NO</th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-left">
                                    NAMA<br>
                                    <span class="font-normal text-gray-500 dark:text-gray-400 text-xs">TEMPAT TANGGAL LAHIR</span>
                                </th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center">NIP</th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center">
                                    PANGKAT<br>
                                    <span class="font-normal text-xs">GOL/RUANG</span>
                                </th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-left">JABATAN</th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center">
                                    PEND.<br>
                                    <span class="font-normal text-xs">TERAKHIR</span>
                                </th>
                                <th class="border border-gray-300 dark:border-gray-600 px-2 py-2 text-center">
                                    USIA<br>
                                    <span class="font-normal text-xs">(THN)</span>
                                </th>
                            </tr>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="border border-gray-300 dark:border-gray-600 px-4 py-8 text-center text-gray-400 dark:text-gray-500">
