        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            <div>
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                    Rekapitulasi <span class="text-base font-normal text-gray-500 dark:text-gray-400">Data Status Kepegawaian</span>
                </h1>
            </div>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-full xl:col-span-5 bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Daftar Status Kepegawaian</h2>
                </header>
                    ...
                    <table class="w-full text-sm">
                        <thead class="text-xs font-semibold uppercase text-gray-500 bg-gray-50 dark:bg-gray-700 dark:bg-opacity-50">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left">Status Kepegawaian</th>
                                <th class="px-4 py-3 text-center">Jumlah</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach ($statusKepegawaian as $index => $data)
                                <tr>
                                    <td class="px-4 py-3">{{ $index + 1 }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">{{ $data->status_kepegawaian }}</td>
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-700">
                            <tr class="font-bold text-gray-800 dark:text-gray-100">
                                ...
                                <td class="px-4 py-3 text-center">{{ $statusKepegawaian->sum('jumlah') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="col-span-full xl:col-span-7 bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Statistik Status Kepegawaian</h2>
                </header>
                <div class="p-3">
                    <canvas id="statusKepegawaianChart" height="300"></canvas>
                </div>
            </div>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const ctx = document.getElementById('statusKepegawaianChart');
                if (ctx) {
