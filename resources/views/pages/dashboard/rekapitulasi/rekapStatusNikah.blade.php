        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            <div>
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                    Rekapitulasi <span class="text-base font-normal text-gray-500 dark:text-gray-400">Data Pegawai Berdasarkan Status Pernikahan</span>
                </h1>
            </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach ($statusPernikahan as $index => $data)
                                <tr>
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">{{ $data->status_pernikahan }}</td>
