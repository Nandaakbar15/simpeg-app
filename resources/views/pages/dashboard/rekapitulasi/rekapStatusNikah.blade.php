<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            <div>
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                    Rekapitulasi <span class="text-base font-normal text-gray-500 dark:text-gray-400">Data Pegawai
                        Berdasarkan Status Pernikahan</span>
                </h1>
            </div>
        ...
        <div class="no-print grid grid-cols-12 gap-6">
            ...
            <div
                ...
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Daftar Status Pernikahan</h2>
                </header>
                    ...
                    <table class="w-full text-sm">
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left">Status Pernikahan</th>
                                <th class="px-4 py-3 text-center">Jumlah</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach ($statusPernikahan as $index => $data)
                                <tr>
                                    <td class="px-4 py-3">{{ $index + 1 }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">
                                        {{ $data->status_pernikahan }}</td>
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-700">
                            <tr class="font-bold text-gray-800 dark:text-gray-100">
                                ...
                                <td class="px-4 py-3 text-center">{{ $statusPernikahan->sum('jumlah') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div
                ...
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Statistik Status Pernikahan</h2>
                </header>
                <div class="p-3">
                    <canvas id="statusPernikahanChart" height="300"></canvas>
                </div>
            </div>
        </div>
        ...
        <div class="print-area">
            ...
            {{-- Judul --}}
            <p class="print-judul">REKAPITULASI PEGAWAI BERDASARKAN STATUS PERNIKAHAN</p>
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                const ctx = document.getElementById('statusPernikahanChart');
                if (ctx) {
