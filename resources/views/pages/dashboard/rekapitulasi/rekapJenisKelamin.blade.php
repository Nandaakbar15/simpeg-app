        ...
        <div class="sm:flex sm:justify-between sm:items-center mb-4">
            <div>
                ...
                <h1 class="text-2xl md:text-3xl text-gray-800 dark:text-gray-100 font-bold">
                    Rekapitulasi <span class="text-base font-normal text-gray-500 dark:text-gray-400">Data Pegawai Berdasarkan Jenis Kelamin</span>
                </h1>
            </div>
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-full xl:col-span-5 bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Daftar Jenis Kelamin</h2>
                </header>
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach ($jenisKelamin as $index => $data)
                                <tr>
                                    <td class="px-4 py-3">{{ $index + 1 }}</td>
                                    <td class="px-4 py-3 font-medium text-gray-800 dark:text-gray-100">{{ $data->jenis_kelamin }}</td>
                        ...
                        <tfoot class="bg-gray-50 dark:bg-gray-700">
                            <tr class="font-bold text-gray-800 dark:text-gray-100">
                                ...
                                <td class="px-4 py-3 text-center">{{ $jenisKelamin->sum('jumlah') }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
            ...
            <div class="col-span-full xl:col-span-7 bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
                <header class="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="font-semibold text-gray-800 dark:text-gray-100">Statistik Jenis Kelamin</h2>
                </header>
                <div class="p-3">
